<?php $weg = 'http://'.$_SERVER['SERVER_NAME'].'/'.$editdir.'/contentedit'; ?>
<link href="<?=$weg?>/css/fontAwesome.css" rel="stylesheet">
<link href="<?=$weg?>/css/style.css" rel="stylesheet">
<script src="<?=$weg?>/js/jquery.js"></script>
<div class="toolbar">
...
<div class="editor" contenteditable="true">... ЗДЕСЬ ТЕКСТ ...</div>

<script src="<?=$weg?>/js/script.js"></script>